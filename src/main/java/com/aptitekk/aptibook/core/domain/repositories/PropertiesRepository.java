...
@EntityRepository
public class PropertiesRepository extends MultiTenantEntityRepositoryAbstract<Property> {
    ...
    public Property findPropertyByKey(Property.Key propertyKey) {
        return findPropertyByKey(propertyKey, getTenant());
    }
     ...
     * @return the Property Entity if found, null otherwise.
     */
    public Property findPropertyByKey(Property.Key propertyKey, Tenant tenant) {
    ...
    public List<Property> findAllPropertiesByGroup(Property.Group propertyGroup) {
        return findAllPropertiesByGroup(propertyGroup, getTenant());
    }
     ...
     * @return A list containing all Property Entities that are within the Group.
     */
    public List<Property> findAllPropertiesByGroup(Property.Group propertyGroup, Tenant tenant) {

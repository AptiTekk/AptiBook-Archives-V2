...
/**
 * This class creates a Tenant for demonstration purposes with the domain "demo".
 * The Tenant is rebuilt every 24 hours.
 */
@Service
public class DemoTenantBuilder {
    ...
    public void rebuildDemoTenant() {
        ...
        //TODO: Make method in user repositories to get admin user, set admin to get notifications.

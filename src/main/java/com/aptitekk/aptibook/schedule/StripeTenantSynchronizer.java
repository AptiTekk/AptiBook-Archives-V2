...
/**
 * This class synchronizes subscriptions with Stripe in order to create, modify, and delete Tenants as needed.
 */
@Service
public class StripeTenantSynchronizer {
    ...
    @Autowired
    public StripeTenantSynchronizer(TenantRepository tenantRepository,

...
public abstract class EntityRepositoryAbstract<T> {
    ...
    /**
     * The Class of the current entities.
     */
    Class<T> entityType;
    ...
    /**
     * Finds an entities from the database by its ID.
     * Searches through all Tenants.
     *
     * @param id The ID to find.
     * @return The entities with the ID, if one was found. Null if not found.
     */
    ...
    /**
     * Deletes an entities from the database.
     *
     * @param entity The entities to delete.
     */

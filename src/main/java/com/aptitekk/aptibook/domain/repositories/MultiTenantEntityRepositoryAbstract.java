...
import com.aptitekk.aptibook.domain.entities.MultiTenantEntity;
...
public abstract class MultiTenantEntityRepositoryAbstract<T extends MultiTenantEntity> extends EntityRepositoryAbstract<T> {
    ...
    /**
     * Saves the entities to the database. If data for the entities does not exist in the database, it will be inserted.
     * Otherwise, it will be updated.
     * <p>
     * If the entities's tenant is null, the tenant will be assigned automatically.
     *
     * @param entity The entities to save.
     * @return The saved version of the entities.
     */
    @Override
    ...
    /**
     * Finds an entities by its id within the current tenant.
     * If the id does not belong to the tenant, the entities will not be found, even if the id exists.
     *
     * @param id The id of the entities to find.
     * @return The entities if found; otherwise null.
     */

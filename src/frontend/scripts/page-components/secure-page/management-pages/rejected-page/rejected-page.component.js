...
var RejectedPageComponent = (function () {
    function RejectedPageComponent(reservationManagementService, loaderService, authService) {
    ...
    RejectedPageComponent.prototype.ngOnInit = function () {
        var _this = this;
     ...
     */
    RejectedPageComponent.prototype.onReservationSelected = function (reservation) {
     ...
     */
    RejectedPageComponent.prototype.onReservationDeselected = function () {
        this.selectedReservation = null;
    };
    RejectedPageComponent.prototype.deselectAll = function () {
        this.dataTable.deselectRows();
    };
    return RejectedPageComponent;
}());
__decorate([
...
], RejectedPageComponent.prototype, "approvalModal", void 0);
__decorate([
    core_1.ViewChild(datatable_component_1.DataTableComponent),
    __metadata("design:type", datatable_component_1.DataTableComponent)
], RejectedPageComponent.prototype, "dataTable", void 0);
RejectedPageComponent = __decorate([
    core_1.Component({
...
exports.RejectedPageComponent = RejectedPageComponent;
//# sourceMappingURL=rejected-page.component.js.map